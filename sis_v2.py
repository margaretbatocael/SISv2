...
class Home(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="WELCOME TO STUDENT INFORMATION SYSTEM", font=("Times New Roman", 30))
        ...
        self.course=Button(self, font=("Times New Roman", 15), padx = 3, width=30, height=10, bd=0,  text="C O U R S E S",anchor=W, bg="MediumPurple4",fg="white", command=lambda: controller.show(Courses))
        self.course.config(cursor= "hand2")
        self.course.place(x=700,y=160)
...
class Courses(tk.Frame):
    def __init__(self, parent, controller):
        ...
        def delete_course(): 
            try:
                ...
                if messageDelete > 0:   
                    ...
                    tkinter.messagebox.askyesno("SIS", "Deleted!")
                    display_course()
                    con.close()                    
            except:
                tkinter.messagebox.showerror("SIS", "Students are enrolled in this course")
        ...
        self.lblccode = Label(self, font=("Times New Roman", 12, "bold"), text="COURSE CODE:", padx=5, pady=5)
        ...
        self.lblcname = Label(self, font=("Times New Roman", 12,"bold"), text="COURSE NAME:", padx=5, pady=5)
...
class Students(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="STUDENTS", font=("Times New Roman", 40))
        label.place(x=130,y=20)
        ...
        self.lblid = Label(self, font=("Times New Roman", 12,"bold"), text="ID Number:", padx=5, pady=5)
        ...
        self.lblname = Label(self, font=("Times New Roman", 12,"bold"), text="Name:", padx=5, pady=5)
        ...
        self.lblc = Label(self, font=("Times New Roman", 12,"bold"), text="Course Code:", padx=5, pady=5)
        ...
        self.lblyear = Label(self, font=("Times New Roman", 12,"bold"), text="Year Level:", padx=5, pady=5)
        ...
        self.lblgender = Label(self, font=("Times New Roman", 12,"bold"), text="Gender:", padx=5, pady=5)
